...
import { Loader2, Save, X, Trash2, CheckSquare, Square, HardDrive } from 'lucide-react';
        ...
        <DialogHeader className="p-8 border-b bg-card">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <DialogTitle className="text-3xl font-display font-bold">Manage Gallery</DialogTitle>
